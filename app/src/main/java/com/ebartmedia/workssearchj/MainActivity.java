...
public class MainActivity extends AppCompatActivity
    ...
    private void fetchData() {
        ...
        compositeDisposable.add(myAPI.getLoginResult()
    ...
    private void displayData(List<LoginResult> loginResults) {
        ...
        Log.d("displayData", "Display Data");

        Log.d("displayData", "loginResults" + loginResults);


        Log.d("displayData", "loginResults" + loginResults.get(0).username.toString());
        Log.d("displayData", "loginResults" + loginResults.get(0).success.toString());
    }
